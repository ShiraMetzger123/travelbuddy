...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final YbqLibraryAccessors laccForYbqLibraryAccessors = new YbqLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at ybq
     */
    public YbqLibraryAccessors getYbq() {
        return laccForYbqLibraryAccessors;
    }
    ...
    public static class YbqLibraryAccessors extends SubDependencyFactory {
        private final YbqAndroidLibraryAccessors laccForYbqAndroidLibraryAccessors = new YbqAndroidLibraryAccessors(owner);

        public YbqLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at ybq.android
         */
        public YbqAndroidLibraryAccessors getAndroid() {
            return laccForYbqAndroidLibraryAccessors;
        }

    }

    public static class YbqAndroidLibraryAccessors extends SubDependencyFactory {

        public YbqAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getSpinkit() {
                return create("ybq.android.spinkit");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: navigationFragmentKtx (2.8.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigationUiKtx (2.8.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
